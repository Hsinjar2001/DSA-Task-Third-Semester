...
public class TicketBookingSystem extends JFrame {
    ...
    // NEW: Updated Colors for seat visualization
    private static final Color AVAILABLE_COLOR = new Color(245, 245, 245);       // Off-white for available seats
    private static final Color BOOKED_COLOR = new Color(192, 57, 43);            // Darker red for booked
    private static final Color SELECTED_COLOR = new Color(41, 128, 185);         // Rich blue for selection
    private static final Color PROCESSING_COLOR = new Color(241, 148, 138);      // Light coral for processing
    ...
    private JPanel createSeatPanel() {
        ...
        panel.setBorder(new TitledBorder("Seating Chart (Off-white=Available, Blue=Selected, Dark Red=Booked, Light Coral=Processing)"));
