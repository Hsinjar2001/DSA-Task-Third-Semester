...
public class TrafficSignalSystem extends JFrame {
    ...
    private enum VehicleType {
        CAR(1, new Color(52, 152, 219)),            // Soft Blue instead of Color.BLUE
        TRUCK(2, new Color(149, 165, 166)),         // Muted Gray instead of Color.GRAY
        AMBULANCE(10, new Color(241, 196, 15)),     // Gold instead of Color.WHITE
        FIRE_TRUCK(10, new Color(231, 76, 60));     // Strong Red instead of Color.RED
    ...
    private JPanel createInfoPanel() {
        ...
        emergencyArea.setBackground(new Color(255, 235, 238)); // Soft pink background (lighter than before)
    ...
    private class IntersectionPanel extends JPanel {
        public IntersectionPanel() {
            ...
            setBackground(new Color(33, 33, 33)); // Darker gray background instead of Color.DARK_GRAY
        }
        ...
        private void drawRoads(Graphics2D g2d) {
            // Road surface
            g2d.setColor(new Color(45, 45, 45)); // Darker road color (instead of Color.BLACK)
            ...
            // Lane markings
            g2d.setColor(new Color(255, 215, 0)); // Gold-ish dashed lines instead of yellow
        ...
        private void drawTrafficLights(Graphics2D g2d) {
            ...
            // North-South lights
            g2d.setColor(new Color(20, 20, 20)); // Darker black housing
            g2d.fillRect(lightX, lightY, lightSize, lightSize * 3);
            
            g2d.setColor(northSouthLight == TrafficLight.RED ? new Color(220, 20, 60) : new Color(70, 70, 70)); // Crimson red or dark gray
            g2d.fillOval(lightX + 2, lightY + 2, lightSize - 4, lightSize - 4);
            
            g2d.setColor(northSouthLight == TrafficLight.YELLOW ? new Color(255, 215, 0) : new Color(70, 70, 70)); // Gold or dark gray
            g2d.fillOval(lightX + 2, lightY + lightSize + 2, lightSize - 4, lightSize - 4);
            
            g2d.setColor(northSouthLight == TrafficLight.GREEN ? new Color(60, 179, 113) : new Color(70, 70, 70)); // MediumSeaGreen or dark gray
            ...
            g2d.setColor(eastWestLight == TrafficLight.RED ? new Color(220, 20, 60) : new Color(70, 70, 70));
            g2d.fillOval(lightX + 2, lightY + 2, lightSize - 4, lightSize - 4);
            
            g2d.setColor(eastWestLight == TrafficLight.YELLOW ? new Color(255, 215, 0) : new Color(70, 70, 70));
            g2d.fillOval(lightX + 2, lightY + lightSize + 2, lightSize - 4, lightSize - 4);
            
            g2d.setColor(eastWestLight == TrafficLight.GREEN ? new Color(60, 179, 113) : new Color(70, 70, 70));
            g2d.fillOval(lightX + 2, lightY + lightSize * 2 + 2, lightSize - 4, lightSize - 4);
        }
        ...
        private void drawVehicle(Graphics2D g2d, Vehicle vehicle, int x, int y) {
            ...
            // Border
            g2d.setColor(new Color(40, 40, 40));  // Darker border instead of black
            ...
            if (vehicle.type.isEmergency()) {
                g2d.setColor(new Color(255, 69, 0)); // OrangeRed instead of pure red
